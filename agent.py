...
def minimax_max_node(board, color, limit, caching = 0): #returns highest possible utility
    ...
    for i in tup_of_moves:
        ...
        #Let the max do their thing, next player goes
...
def alphabeta_min_node(board, color, alpha, beta, limit, caching = 0, ordering = 0):
    ...
    if ordering == 1:
        ...
        # = []
        tup_of_moves = sorted(get_possible_moves(board, new_color), key = lambda mo: compute_utility(play_move(board, new_color, mo[0], mo[1]), new_color), reverse=True)
        '''
        fat_list = []
...
def alphabeta_max_node(board, color, alpha, beta, limit, caching = 0, ordering = 0):
    ...
    if (ordering == 1):
        #Go through all things in tup of moves
        # = []
        tup_of_moves = sorted(get_possible_moves(board, color), key = lambda mo: compute_utility(play_move(board, color, mo[0], mo[1]), color), reverse=True)
        '''
        fat_list = []
        for mo in tup_of_moves:
